...
const sections = [
  ...
  { icon: Building2, label: "Edifícios", desc: "Torres residenciais", to: "/mapa" as const },
  { icon: Trees, label: "Choupanas ao Ar Livre", desc: "Áreas de convivência 1–6", to: "/mapa" as const },
  { icon: Dumbbell, label: "Academia", desc: "Espaço fitness completo", to: "/mapa" as const },
  { icon: Baby, label: "Brinquedoteca", desc: "Diversão para os pequenos", to: "/mapa" as const },
  { icon: Shirt, label: "Lavanderia", desc: "Serviço self-service", to: "/mapa" as const },
  { icon: Bike, label: "Bicicletário", desc: "Estacionamento para bikes", to: "/mapa" as const },
  { icon: Utensils, label: "Salão Gourmet", desc: "Eventos íntimos", to: "/mapa" as const },
  { icon: PartyPopper, label: "Área de Festas", desc: "Celebrações exclusivas", to: "/mapa" as const },
  { icon: Trophy, label: "Quadras Esportivas", desc: "Quadras 01 e 02", to: "/mapa" as const },
